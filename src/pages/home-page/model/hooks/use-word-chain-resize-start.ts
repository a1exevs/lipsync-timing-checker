...
import { recalculatePhonemesStartEnd } from 'src/pages/home-page/model/converters';
import { Word } from 'src/pages/home-page/model/types';
import { WORD_MIN_WIDTH_PX } from 'src/pages/home-page/ui/word/word.consts';
